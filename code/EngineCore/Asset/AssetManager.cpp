...
namespace EngineCore
{
	...
	ComPtr<ID3D11ShaderResourceView> AssetManager::loadTextureArrayAsset(const std::vector<std::wstring>& TextureList)
	{
		std::string absoluteTexturePath;
		ComPtr<ID3D11ShaderResourceView> mTreeTexArray;

		CreateTexture2DArrayFromFile(
			m_pd3dDevice.Get(),
