...
#include <algorithm>
#include <locale>
#include "../Scene/Component/Common/VertexType.h"
#include "../Scene/Component/Common/LightHelper.h"
...
public:
	struct ObjPart
	{
		...
		std::vector<Geometry::VertexPosNormalTex> vertices;	// 顶点集合
...
private:
	void AddVertex(const Geometry::VertexPosNormalTex& vertex, DWORD vpi, DWORD vti, DWORD vni);
