...
namespace EngineCore
{
	void CameraManager::init()
	{
		...
		m_pd3dImmediateContext->GSSetConstantBuffers(1, 1, m_pViewMatrixCB.GetAddressOf());
		...
		m_pd3dImmediateContext->GSSetConstantBuffers(2, 1, m_pProjMatrixCB.GetAddressOf());
		m_pd3dImmediateContext->PSSetConstantBuffers(2, 1, m_pProjMatrixCB.GetAddressOf());
