#ifndef CYBER_INPUTEVENTMANAGER
#define CYBER_INPUTEVENTMANAGER
...
namespace EngineCore
{
    ...
    class _declspec(dllexport) InputEvent
    {
    public:
    ...
    class _declspec(dllexport) InputEventManager : public ISingleton<InputEventManager>
    {
    public:
        void registerInputEvent(InputEvent* inputEvent);
        void unRegisterInputEvent(InputEvent* inputEvent);
        ...
        void onMouseWheelEvent(const MouseState& mouseState);
    private:
